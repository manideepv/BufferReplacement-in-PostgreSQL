...
typedef struct sbufdesc
{
	...
	/*
			changes by neha  -- Declaration of pointer for double linked likst.
			*/
	int freePrev;
...
/*
			changes by neha  -- Null field is added for prev pointer for list header in linked list
			*/
#define FREEPREV_END_OF_LIST 	(-1)
